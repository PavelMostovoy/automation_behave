...
Feature: Submit form
  ...
  Scenario Outline: Fill Data in the Phone number field
    ...
    Examples:
      | field                        | data       | button              | element                            | message                                      |
      | //*[@id="field-email"]/input | 1234567890 | //*[@type="submit"] | //*[@id="field-email"]/label       | Please enter your 10-digit Cell Phone Number |
      | //*[@id="field-email"]/input | 5509456780 | //*[@type="submit"] | //*[@id="contact-success-sent-to"] | 550-945-6780                                 |
